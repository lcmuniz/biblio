...
@Entity
@Table(name = "EmprestimoMidia")
public class EmprestimoMidia implements Emprestimo {

	@Id
	@GeneratedValue
	@Column(name = "emprestimoMidiaId")
	private Long id;
	...
	@ManyToOne
	@JoinColumn(name = "exemplarMidiaId")
	private ExemplarMidia exemplar;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmprestimoMidia other = (EmprestimoMidia) obj;
		if (getId() == null) {
			if (other.getId() != null)
				return false;
	...
	public String toString() {
		return cliente.getNome() + " - " + exemplar.getMidia().getTitulo();
	}
	...
	public ExemplarMidia getExemplar() {
		return exemplar;
	}

	public void setExemplar(ExemplarMidia exemplar) {
