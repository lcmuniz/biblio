...
public class Validations {
	...
	public static void show(Component component, String whereShowDefault, HashMap<String, String> erros) {
		...
		if (erros != null) {
			...
			for (String key : erros.keySet()) {
				...
				if (component.getFellowIfAny(key, true) != null) {
					...
					if (component.getFellowIfAny(whereShowDefault, true) != null) {
						wvelist.add(new WrongValueException(component.getFellow(whereShowDefault, true), value));
					}
				}
			}
